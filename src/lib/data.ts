        ...
        milestones: [
          {
            ...
            days: 'Días 1-2',
            tasks: [
              { id: 'T1.1', title: 'Inicializar un nuevo proyecto de Laravel.', dueDate: 'lunes, 11 de nov', completed: true, details: 'Crear un nuevo repositorio y clonar el esqueleto de Laravel. Ejecutar `composer install`.' },
              { id: 'T1.2', title: 'Configurar la conexión a la base de datos MySQL.', dueDate: 'lunes, 11 de nov', completed: true, details: 'Actualizar el archivo `.env` con las credenciales de la base de datos de desarrollo (DB_HOST, DB_PORT, DB_DATABASE, DB_USERNAME, DB_PASSWORD).' },
