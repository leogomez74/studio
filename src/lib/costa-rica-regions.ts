// Fuente oficial: Registro Nacional / Instituto Geográfico Nacional de Costa Rica
// División Territorial Administrativa 2022 — 7 provincias, 83 cantones, 490 distritos

export type CostaRicaProvince = {
  name: string;
  cantons: { name: string; districts: string[] }[];
};
