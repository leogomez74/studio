  ...
  return (
    <Tabs defaultValue="all">
      ...
      <TabsContent value="all">
        <Card>
          <CardHeader>
            <CardTitle>Todos los Amparos</CardTitle>
            <CardDescription>Gestiona todos los amparos legales.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <TabsContent value="contenciosa">
        <Card>
          <CardHeader>
            <CardTitle>Amparos de Contenciosa</CardTitle>
      ...
      <TabsContent value="no-contenciosa">
        <Card>
          <CardHeader>
            <CardTitle>Amparos de No Contenciosa</CardTitle>
        ...
        <div className="relative w-full overflow-auto">
            ...
            <TableBody>
                ...
                <TableRow key={caseItem.id} className="hover:bg-muted/50">
                    <TableCell>
                      <Link href={`/dashboard/amparos/${caseItem.id.toLowerCase()}`} className="font-medium hover:underline">
                        {caseItem.title}
                      </Link>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuItem asChild>
                            <Link href={`/dashboard/amparos/${caseItem.id.toLowerCase()}`}>Ver Detalles</Link>
                        </DropdownMenuItem>
