...
import { ArrowLeft, ArrowRight, User as UserIcon, Save, Loader2, PanelRightClose, PanelRightOpen, Pencil, Sparkles, Archive, Plus, Paperclip, RefreshCw, ChevronsUpDown, Check, Eye, X, AlertCircle, Handshake, DollarSign } from "lucide-react";
