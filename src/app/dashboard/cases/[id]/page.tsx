    ...
    if (!caseItem) {
      return (
        <div className="text-center">
          <p className="text-lg">Caso no encontrado</p>
        ...
        <div className="flex items-center gap-4">
          <Button variant="outline" size="icon" asChild>
            <Link href="/dashboard/cases">
              ...
              <span className="sr-only">Volver a Casos</span>
            </Link>
          </Button>
          <h1 className="text-2xl font-semibold">Detalles del Caso: {caseItem.id}</h1>
        </div>
  
        {/* Grid para organizar las tarjetas de información. */}
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
          {/* Columna principal con detalles del caso y pruebas (60%) */}
          ...
          {/* Columna lateral para el módulo de Helpdesk (chat) (40%) */}
