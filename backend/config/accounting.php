...
return [
    ...
    */
    ...
    'use_configurable_by_type' => [
        ...
        'PAGO_SALDO_PENDIENTE'       => env('ACCOUNTING_CONFIGURABLE_PAGO_SALDO_PENDIENTE', true),
        'ANULACION_SALDO_APLICADO'   => env('ACCOUNTING_CONFIGURABLE_ANULACION_SALDO_APLICADO', true),
        'ANULACION_ABONO_CAPITAL'    => env('ACCOUNTING_CONFIGURABLE_ANULACION_ABONO_CAPITAL', true),
        'ANULACION_REINTEGRO_SALDO'  => env('ACCOUNTING_CONFIGURABLE_ANULACION_REINTEGRO_SALDO', true),
        // Inversiones
        ...
        'INV_RETENCION_INTERES'  => env('ACCOUNTING_CONFIGURABLE_INV_RETENCION', false),
        'INV_CANCELACION_TOTAL'  => env('ACCOUNTING_CONFIGURABLE_INV_CANCELACION', false),
        'INV_PAGO_CAPITAL'       => env('ACCOUNTING_CONFIGURABLE_INV_PAGO_CAPITAL', false),
    ],
];
