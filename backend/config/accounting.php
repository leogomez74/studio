...
return [
    ...
    */
    ...
    'use_configurable_by_type' => [
        ...
        'PAGO_SALDO_PENDIENTE'     => env('ACCOUNTING_CONFIGURABLE_PAGO_SALDO_PENDIENTE', false),
        'ANULACION_SALDO_APLICADO' => env('ACCOUNTING_CONFIGURABLE_ANULACION_SALDO_APLICADO', false),
        // Inversiones
